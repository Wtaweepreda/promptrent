  ...
  return {
      ...
      contents: [
        {
          ...
          contents: [
            ...
            },
            {
              ...
              flex: 0,
              contents: [
                { type: 'text', text: 'STEP 1 of 3', size: 'xxs', color: '#0D1B0D', weight: 'bold' },
              ],
            },
          ],
        },
        { type: 'text', text: 'Welcome to', size: 'xl', weight: 'bold', color: '#FFFFFF', margin: '20px' },
        { type: 'text', text: 'PromptRent 🏠', size: 'xxl', weight: 'bold', color: '#69F0AE' },
        {
          type: 'text',
          text: 'Track payments · Build trust · Open doors.',
          size: 'sm', color: '#888888', margin: '10px', wrap: true,
        },
        { type: 'separator', color: '#1E331E', margin: '16px' },
        {
          type: 'box', layout: 'horizontal', margin: '12px', spacing: 'md',
          contents: [
            {
              type: 'box', layout: 'vertical', flex: 1, backgroundColor: '#1A2E1A',
              cornerRadius: '8px', paddingAll: '10px', alignItems: 'center',
              contents: [
                { type: 'text', text: '📋', size: 'lg', align: 'center' },
                { type: 'text', text: 'Step 2', size: 'xxs', color: '#666666', align: 'center', margin: '4px' },
                { type: 'text', text: 'Set up lease', size: 'xxs', color: '#888888', align: 'center', wrap: true },
              ],
            },
            {
              type: 'box', layout: 'vertical', flex: 1, backgroundColor: '#1A2E1A',
              ...
              contents: [
                { type: 'text', text: '🔗', size: 'lg', align: 'center' },
                { type: 'text', text: 'Step 3', size: 'xxs', color: '#666666', align: 'center', margin: '4px' },
                { type: 'text', text: 'Connect & track', size: 'xxs', color: '#888888', align: 'center', wrap: true },
              ],
            },
          ],
        },
    ...
    body: {
      ...
      contents: [
        ...
        { type: 'text', text: 'Choose your role — both landlords and tenants are welcome', size: 'sm', color: '#888888', align: 'center', wrap: true },
        { type: 'separator', color: '#1E331E', margin: '8px' },
        {
          type: 'button',
          action: { type: 'postback', label: '🏠  I\'m a Landlord', data: 'action=role_landlord', displayText: "I'm a Landlord" },
          style: 'primary', color: '#00C853', height: 'sm',
        },
        {
          type: 'button',
          action: { type: 'postback', label: '🙋  I\'m a Tenant', data: 'action=role_tenant', displayText: "I'm a Tenant" },
          style: 'primary', color: '#1A3A1A', height: 'sm',
        },
      ],
    },
  };
